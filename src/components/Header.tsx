...
export const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'backdrop-blur-lg bg-[#131a26]/70 py-4' : 'py-6'}`}>
      ...
      {/* Mobile Navigation */}
      {mobileMenuOpen && (
        <nav className="md:hidden absolute top-full left-0 right-0 backdrop-blur-xl bg-[#131a26]/90 border-t border-gray-800">
          <div className="container mx-auto px-6 py-4 flex flex-col space-y-4">
            ...
            <Link to="/portfolio" className="text-gray-300 hover:text-white transition-colors py-2" onClick={() => setMobileMenuOpen(false)}>
              Portfolio
            </Link>
